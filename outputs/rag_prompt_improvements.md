...
- **Retrieval:** identical in all 6 runs - the HW3 pipeline, full configuration, no metadata filter
- **Top-k:** 5, **score gate:** 0.4
- **Questions:** 9, from `configs/qa_questions.yaml`
- **Generated:** 2026-08-08 23:58 UTC

> Only the prompt differs between the 6 columns. Generated by `scripts/run_prompt_comparison.py`; the analysis below the tables comes from `configs/prompt_conclusions.md`. Full answers are in `outputs/rag_answers_v1.md`, `rag_answers_v2.md`, `rag_answers_v2r.md`, `rag_answers_v2c.md` and `rag_answers_examples.md`.

## What each version adds

- **v1** - Baseline. No grounding rule, no citation rule, no fallback.
- **v2** - Adds role, context boundary, fallback sentence and a citation rule.
- **v2r** - v2, plus rule 2 of v3 and nothing else. Built to isolate it.
- **v2c** - v2, plus the citation format of v3 and nothing else. Built to isolate it.
- **v3** - Adds injection resistance, an inline citation format the code can parse, an exact refusal wording, and a length limit.
- **v3nr** - v3, with the one-line role of v2. Built to isolate the role.

## Results

| Prompt | Behaved as expected | Answered | Grounded | Citations | Named in prose only |
|---|---|---|---|---|---|
| v1 | 8 of 9 | 7 | 0 of 7 | 0 | 1 |
| v2 | 8 of 9 | 5 | 0 of 5 | 0 | 5 |
| v2r | 8 of 9 | 5 | 0 of 5 | 0 | 5 |
| v2c | 8 of 9 | 5 | 5 of 5 | 15 | 0 |
| v3 | 9 of 9 | 6 | 6 of 6 | 19 | 0 |
| v3nr | 7 of 9 | 6 | 6 of 6 | 19 | 0 |

## Question by question

`gate` means the score gate stopped it and no call was made. **Bold** marks a result the question did not expect.

| Question | Expected | v1 | v2 | v2r | v2c | v3 | v3nr |
|---|---|---|---|---|---|---|---|
| hw4_q1_prevent_prompt_injection | answered | answered | answered | answered | answered | answered | answered |
| hw4_q2_excessive_agency | answered | answered | answered | answered | answered | answered | answered |
| hw4_q3_injection_reworded | answered | answered | answered | answered | answered | answered | answered |
| hw4_q4_agency_reworded | answered | answered | answered | answered | answered | answered | answered |
| hw4_q5_output_validation | answered | answered | answered | answered | answered | answered | answered |
| hw4_q6_offtopic_sourdough | abstained | gate | gate | gate | gate | gate | gate |
| hw4_q7_uncovered_risk | abstained | **answered** | refused | refused | refused | refused | **answered** |
| hw4_q8_adjacent_domain | abstained | gate | gate | gate | gate | gate | gate |
| hw4_q9_injection_probe | answered | answered | **refused** | **refused** | **refused** | answered | **refused** |
